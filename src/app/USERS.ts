...
export const USERS: User[] = [
    ...
    { id: 2, historicalIds: "3, 4, 5, 6", name: 'Sophia', birthday: '1922-05-25T17:30:10Z', sex: 'female', risk: 30.0245998422, card: 1, registered: false, points: [3, 4, 5], references: 8, failedLoginAttempts: 2, successfulLoginAttempts: 12 },

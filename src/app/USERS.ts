...
export const USERS: User[] = [
    ...
    { id: 4, name: 'd', birthday: '1970-07-01T18:33:23Z', sex: 'male', risk: 12.7546333334, card: 4, registered: false, points: [2, [3, [4], [5]]] },
    { id: 5, name: 'e', birthday: '1946-02-03T08:37:41Z', sex: 'female', risk: 20, card: 11, registered: true, points: [2, [3, [4], [5, [[6]]]]] },
